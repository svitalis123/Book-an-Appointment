...
Reservation.create(vehicle: "Honda", model: "Accord", year: 2021, color: "Red", location: "New York", service: "Tire Rotation", username: "janedoe", date: Date.tomorrow)
Reservation.create(vehicle: "Ford", model: "Mustang", year: 2020, color: "Black", location: "Chicago", service: "Brake Inspection", username: "bobsmith", date: Date.today + 1.week)
